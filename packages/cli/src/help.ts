...
Planning:
  ...
  ordewell plan --goal "text"     Plan a goal conversationally (honours grill-me/PRD/review)
...
Modes:
  ...
  ordewell review [on|off]    Toggle review mode — adds a final opinion-review task, human sign-off (or show status)
